			...
			<div class="row">
		        ...
		        <div class="col-md-12">
		          ...
		          <div class="box box-primary">
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            <form action="${pageContext.request.contextPath}/user/updeteUser.action" method="post">
		              <div class="box-body" >
		                <div style="height: 100px;">			               	 	                	
			                <div style="width: 48%;float: left;">
			                  <label for="exampleInputFile">头像</label>
			                  <input type="file" id="exampleInputFile" name="img" value="${userXg.img }">				                
			                </div>
		                ...
		                <div style="height: 100px;">			                		 
		                	<div style="width: 48%;float: left;">
			                  ...
			                  <input id="name" type="text" class="form-control" placeholder="请填写登录名" name="name" value="${userXg.name }">		                  
			                </div>
			                <div style="width: 48%;float: right;">
			                  <label>格言</label>
			                  <input type="text" class="form-control" placeholder="请填写您喜欢的格言" name="dictum" value="${userXg.dictum }">		                  
			                </div>
		                </div>  
		              	<div style="height: 100px;">			                		 
		                	<div style="width: 48%;float: left;">
			                  <label>密码</label><span id="pwd3" style="color: red;display: none;"> :两次密码不统一</span>
			                  <input id="pwd1" type="text" class="form-control" placeholder="请填写密码" value="${userXg.pwd }">		                  
			                </div>
			                <div style="width: 48%;float: right;">
			                  <label>确认密码</label>
			                  <input id="pwd2" type="text" class="form-control" placeholder="请填写登录密码 " name="pwd" value="${userXg.pwd }">
			                </div>
		                </div>  
		                <div style="height: 100px;">			                		 
		                	<div style="width: 48%;float: left;">
			                  <label>性别</label>
			                  <select class="form-control" name="sex" value="${userXg.sex }">
			                ...
			                <div style="width: 48%;float: right;">
			                  <label>昵称</label>
			                  <input type="text" class="form-control" placeholder="请填写您的昵称" name="nickname" value="${userXg.nickname }">
			                </div>
		                </div>            
		              </div>
		              <input type="hidden" name="id" value="${userXg.id}">
		              <!-- /.box-body -->
		              <div class="box-footer" style="padding-right: 15%;padding-left: 15%;">
		                <button type="reset" class="btn btn-primary">重新填写</button>
		                <button type="submit" class="btn btn-primary" style="float: right;">确认修改</button>
		              </div>
		            </form>
		          </div>
		          <!-- /.box -->
